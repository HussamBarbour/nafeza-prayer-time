...
function nafeza_prayer_time_settings_api_init()
{
    add_settings_section(
        ...
        esc_attr__('General settings', 'nafeza-prayer-time') . '<hr />',
        '',
        'nafeza_prayer_time_admin_page'
    );
    add_settings_field(
        'nafeza_prayer_time_setting_view_imsak',
        esc_attr__('Enable Imsak', 'nafeza-prayer-time'),
    ...
    add_settings_field(
        ...
        esc_attr__('Calculation Method', 'nafeza-prayer-time'),
    ...
    add_settings_field(
        ...
        esc_attr__('Calculation School', 'nafeza-prayer-time'),
    ...
    add_settings_field(
        ...
        esc_attr__('Fixed location', 'nafeza-prayer-time'),
    ...
    add_settings_field(
        ...
        esc_attr__('Latitude', 'nafeza-prayer-time'),
    ...
    add_settings_field(
        ...
        esc_attr__('Longitude', 'nafeza-prayer-time'),
    ...
    add_settings_field(
        ...
        esc_attr__('City', 'nafeza-prayer-time'),
    ...
    add_settings_field(
        ...
        esc_attr__('Country', 'nafeza-prayer-time'),
    ...
    add_settings_field(
        ...
        esc_attr__('Time Format', 'nafeza-prayer-time'),
    ...
    add_settings_field(
        ...
        esc_attr__('Enable Notifications', 'nafeza-prayer-time'),
    ...
    add_settings_field(
        ...
        esc_attr__('Notification icon', 'nafeza-prayer-time'),
    ...
    add_settings_section(
        ...
        esc_attr__('Time difference', 'nafeza-prayer-time'),
        '',
        'nafeza_prayer_time_admin_page2'
    );
    add_settings_field(
        'nafeza_prayer_time_setting_imsak_difference',
        esc_attr__('IMSAK', 'nafeza-prayer-time'),
    ...
    add_settings_field(
        ...
        esc_attr__('FAJR', 'nafeza-prayer-time'),
    ...
    add_settings_field(
        ...
        esc_attr__('SUNRISE', 'nafeza-prayer-time'),
    ...
    add_settings_field(
        ...
        esc_attr__('DHUHR', 'nafeza-prayer-time'),
    ...
    add_settings_field(
        ...
        esc_attr__('ASR', 'nafeza-prayer-time'),
    ...
    add_settings_field(
        ...
        esc_attr__('MAGHRIB', 'nafeza-prayer-time'),
    ...
    add_settings_field(
        ...
        esc_attr__('ISHA', 'nafeza-prayer-time'),
...
function nafeza_prayer_time_setting_callback_notification_icon()
{
    ...
    echo '<button type="button" class="button-secondary" id="upload-icon">' . esc_attr__('Upload Icon', 'nafeza-prayer-time') . '</button> <input name="nafeza_prayer_time_setting_notification_icon" id="nafeza_prayer_time_setting_notification_icon" type="text" value="' . esc_attr(get_option('nafeza_prayer_time_setting_notification_icon')) . '" /> <button type="button" class="button-secondary" id="delete-icon">' . esc_attr__('Delete') . '</button> <div><img id="nafeza_prayer_time_icon_img" src="' . esc_url($icon_url) . '" /></div>';
}

function nafeza_prayer_time_setting_callback_imsak_difference()
{
    echo '<input name="nafeza_prayer_time_setting_imsak_difference" id="nafeza_prayer_time_setting_imsak_difference" type="number" value="' . esc_attr(get_option('nafeza_prayer_time_setting_imsak_difference', 0)) . '" /> ' . esc_attr__('minute', 'nafeza-prayer-time');
}

function nafeza_prayer_time_setting_callback_fajr_difference()
{
    echo '<input name="nafeza_prayer_time_setting_fajr_difference" id="nafeza_prayer_time_setting_fajr_difference" type="number" value="' . esc_attr(get_option('nafeza_prayer_time_setting_fajr_difference', 0)) . '" /> ' . esc_attr__('minute', 'nafeza-prayer-time');
}

function nafeza_prayer_time_setting_callback_sunrise_difference()
{
    echo '<input name="nafeza_prayer_time_setting_sunrise_difference" id="nafeza_prayer_time_setting_sunrise_difference" type="number" value="' . esc_attr(get_option('nafeza_prayer_time_setting_sunrise_difference', 0)) . '" /> ' . esc_attr__('minute', 'nafeza-prayer-time');
}

function nafeza_prayer_time_setting_callback_duhur_difference()
{
    echo '<input name="nafeza_prayer_time_setting_duhur_difference" id="nafeza_prayer_time_setting_duhur_difference" type="number" value="' . esc_attr(get_option('nafeza_prayer_time_setting_duhur_difference', 0)) . '" /> ' . esc_attr__('minute', 'nafeza-prayer-time');
}

function nafeza_prayer_time_setting_callback_asr_difference()
{
    echo '<input name="nafeza_prayer_time_setting_asr_difference" id="nafeza_prayer_time_setting_asr_difference" type="number" value="' . esc_attr(get_option('nafeza_prayer_time_setting_asr_difference', 0)) . '" /> ' . esc_attr__('minute', 'nafeza-prayer-time');
}

function nafeza_prayer_time_setting_callback_maghrib_difference()
{
    echo '<input name="nafeza_prayer_time_setting_maghrib_difference" id="nafeza_prayer_time_setting_maghrib_difference" type="number" value="' . esc_attr(get_option('nafeza_prayer_time_setting_maghrib_difference', 0)) . '" /> ' . esc_attr__('minute', 'nafeza-prayer-time');
}

function nafeza_prayer_time_setting_callback_isha_difference()
{
    echo '<input name="nafeza_prayer_time_setting_isha_difference" id="nafeza_prayer_time_setting_isha_difference" type="number" value="' . esc_attr(get_option('nafeza_prayer_time_setting_isha_difference', 0)) . '" /> ' . esc_attr__('minute', 'nafeza-prayer-time');
}
