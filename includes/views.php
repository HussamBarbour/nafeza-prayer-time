    ...
    <script>
        ...
        if (nafeza_prayer_time_notification !== 'true') {
            if (Notification.permission !== "granted")
                ...
                var notification = new Notification('<?php echo esc_js(esc_attr__('Prayer Times', 'nafeza-prayer-time')); ?>', {
                    icon: "<?php echo esc_url($icon_url); ?>",
                    body: "<?php echo esc_js(sprintf(esc_attr__('Time remaining for %s prayer: ', 'nafeza-prayer-time'), $data->next_prayer) . $data->next_time_after); ?>"
                });
